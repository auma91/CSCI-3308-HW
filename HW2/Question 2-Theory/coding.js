function display2_1() {
  var myanswer  = "My answer goes here: here is my my dummy answer" // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "My answer goes here: here is my my dummy answer" // TODO 2.2: Fill in Answer here
...
function countDiv() { // Do not add or remove lines to this function
    var divs = document.dummyMethod; // TODO: Question 2.3: Use the document Object to get the number of divs in the HTML page. Replace dummyMethod with the correct one.
...
function makeOrange() { // Do not add or remove lines to this function
    var narutos = document.dummyMethod; // TODO: Question 2.4: Use the document Object to get all tags named "naruto" in the HTML page. Replace dummyMethod with the correct one.
...
function getChildrenTags() { // Do not add or remove lines to this function
  var children = document.dummyMethod; // TODO: Question 2.5 Use the appropriate function to get all the children of a div named 'div_1134'
