function display2_1() {
  var myanswer  = "My answer goes here: undefined, true, false" // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "My answer goes here: x is not declared, so this would have some error." // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "My answer goes here: So, this method is getting an element by its id, and then we are pulling a collection of the children, the children being all the tags enclosed by the div in this case. From there, we can do operations like pull out tags inside that div."; // TODO 2.5: Fill in Answer here
